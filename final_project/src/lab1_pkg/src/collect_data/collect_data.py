...
if not os.stat('./inputValue.mat').st_size == 0:
	old_inputValue = sio.loadmat('./inputValue.mat')['inputValue']
	old_angel_pos =  sio.loadmat('./angle_pos.mat')['angle_pos']
	old_threeD_pos = sio.loadmat('./threeD_pos.mat')['threeD_pos']
