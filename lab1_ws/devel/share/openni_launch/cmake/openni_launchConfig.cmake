...
if("TRUE" STREQUAL "TRUE")
  set(openni_launch_SOURCE_PREFIX /home/cc/ee106b/sp18/class/ee106b-aaf/ros_workspaces/lab1_ws/src/openni_camera/openni_launch)
  set(openni_launch_DEVEL_PREFIX /home/cc/ee106b/sp18/class/ee106b-aaf/ros_workspaces/lab1_ws/devel)
  ...
  set(openni_launch_INSTALL_PREFIX /home/cc/ee106b/sp18/class/ee106b-aaf/ros_workspaces/lab1_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Isaac I.Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106b/sp18/class/ee106b-aaf/ros_workspaces/lab1_ws/src/openni_camera/openni_launch/${idir}'.  Ask the maintainer 'Isaac I.Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
    endif()
