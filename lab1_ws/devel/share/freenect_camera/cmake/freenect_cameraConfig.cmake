...
if("TRUE" STREQUAL "TRUE")
  set(freenect_camera_SOURCE_PREFIX /home/cc/ee106b/sp18/class/ee106b-aaf/ros_workspaces/lab1_ws/src/freenect_stack/freenect_camera)
  set(freenect_camera_DEVEL_PREFIX /home/cc/ee106b/sp18/class/ee106b-aaf/ros_workspaces/lab1_ws/devel)
  ...
  set(freenect_camera_INSTALL_PREFIX /home/cc/ee106b/sp18/class/ee106b-aaf/ros_workspaces/lab1_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'freenect_camera' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Piyush Khandelwal <piyushk@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'freenect_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106b/sp18/class/ee106b-aaf/ros_workspaces/lab1_ws/src/freenect_stack/freenect_camera/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Piyush Khandelwal <piyushk@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${freenect_camera_dep}_FOUND)
      find_package(${freenect_camera_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${freenect_camera_dep} REQUIRED ${depend_list})
  endif()
