...
"""autogenerated by genpy from object_recognition/ObjectInfo.msg. Do not edit."""
import sys
...
class ObjectInfo(genpy.Message):
  _md5sum = "16c44849a01069f6f5a236682938356e"
  _type = "object_recognition/ObjectInfo"
...
float32[] theta
"""
  __slots__ = ['names','x','y','theta']
  _slot_types = ['string[]','uint16[]','uint16[]','float32[]']
